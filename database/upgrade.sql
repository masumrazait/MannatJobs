...
ALTER TABLE jobseeker_profiles
    ...
    ADD COLUMN IF NOT EXISTS notice_period VARCHAR(30) DEFAULT NULL,
...
ALTER TABLE employer_profiles
    ...
    ADD COLUMN IF NOT EXISTS company_logo_data MEDIUMBLOB DEFAULT NULL,
    ADD COLUMN IF NOT EXISTS company_logo_mime VARCHAR(100) DEFAULT NULL,
